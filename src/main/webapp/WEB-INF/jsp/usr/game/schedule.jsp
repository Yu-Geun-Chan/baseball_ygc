                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var formattedGame = gameInfo.replace(/([가-힣A-Za-z]+)\s*(\d*)\s*vs\s*(\d*)\s*([가-힣A-Za-z]+)/, function(match, team1, score1, score2, team2) {
                            ...
                            if (score1Int > score2Int) {
                                score1 = "<span style='color: #cc0000;'>" + score1 + "</span>";  // 어두운 빨간색
                                score2 = "<span style='color: #000099;'>" + score2 + "</span>";  // 어두운 파란색
                            } else if (score1Int < score2Int) {
                                score1 = "<span style='color: #000099;'>" + score1 + "</span>";  // 어두운 파란색
                                score2 = "<span style='color: #cc0000;'>" + score2 + "</span>";  // 어두운 빨간색
                            } else {
                                // 점수가 동일할 경우
                            ...
                            return team1 + " " + score1 + " vs " + score2 + " " + team2; // 띄어쓰기 추가
                        });
                        ...
                        var row = "<tr>" +
                    		// 날짜가 같으면 빈칸
                            "<td class='" + dateClass + "'>" + (prevDate === currentDate ? "" : currentDate) + "</td>" + 
                            "<td>" + data[i].time + "</td>" +  // 시간
                            "<td>" + formattedGame + "</td>" + // 포맷팅된 경기 정보
                            "<td>" + data[i].location + "</td>" + // 장소
                            "<td>" + data[i].etc + "</td>" + // 비고
                            "</tr>";
