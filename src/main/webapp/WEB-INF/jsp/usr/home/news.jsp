...
<div class="main-content">
    ...
    <div id="team_list" class="news_team">
        <ul>
            ...
            <li style="color:#C30037" data-id="LG"><a href="#"><span class="name">LG</span></a></li>
            <li style="color:#000000" data-id="KT"><a href="#"><span class="name">KT</span></a></li>
            <li style="color:#CD142C" data-id="SK"><a href="#"><span class="name">SSG</span></a></li>
            <li style="color:#1F468F" data-id="NC"><a href="#"><span class="name">NC</span></a></li>
            <li style="color:#0E0E2A" data-id="OB"><a href="#"><span class="name">두산</span></a></li>
            <li style="color:#E20D28" data-id="HT"><a href="#"><span class="name">KIA</span></a></li>
            <li style="color:#D31F40" data-id="LT"><a href="#"><span class="name">롯데</span></a></li>
            <li style="color:#0064B2" data-id="SS"><a href="#"><span class="name">삼성</span></a></li>
            <li style="color:#EF8A2F" data-id="HH"><a href="#"><span class="name">한화</span></a></li>
            <li style="color:#85001F" data-id="WO"><a href="#"><span class="name">키움</span></a></li>
        </ul>
    </div>
    <!-- 네이버 야구 뉴스 링크 -->
