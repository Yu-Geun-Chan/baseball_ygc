...
public class Hanwha {
	...
	public void crawl() {
		...
		try {
			...
			WebElement samsungOption = wait
					.until(ExpectedConditions.elementToBeClickable(By.xpath("//option[text()='한화']")));
			samsungOption.click();
	...
	private void extractPlayerDataToCSV(WebDriver driver, WebDriverWait wait) {
		...
		String filePath = "C:/work_YGC/sts-4.24.0.RELEASE-workspace/baseball_ygc/playersHH.csv";
