...
public class Nc {
	...
	public void crawl() {
		...
		try {
			...
			WebElement samsungOption = wait
					.until(ExpectedConditions.elementToBeClickable(By.xpath("//option[text()='NC']")));
			samsungOption.click();
	...
	private void extractPlayerDataToCSV(WebDriver driver, WebDriverWait wait) {
		...
		String filePath = "C:/work_YGC/sts-4.24.0.RELEASE-workspace/baseball_ygc/playersNC.csv";
